...
<head>
    ...
    <title><?=$title?></title>
    <link rel="icon" href="<?=URL?>public/sources/logo/logo.png">
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary rounded-bottom">
        <div class="container-fluid">
            <a class="navbar-brand" href="<?=URL?>dashboard"><img class="persoLogoSize" src="<?=URL?>public/sources/logo/logo.svg" alt="logo">TrotMan</a>
            ...
            <div class="collapse navbar-collapse" id="navbarColor02">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?=URL?>trotinettes">Nos Trotinettes</a>
                    </li>
                    <li class="nav-item">
